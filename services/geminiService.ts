import { SpellAnalysis, MagicSystem, CasterStatus, SpellEnvironment, DivineProtectionDef, ToolDef, ManifestedSpell } from "../types";
...
export const DIVINE_PROTECTIONS: DivineProtectionDef[] = [
    ...
    { 
        ...
        lore: {
            ...
            alias: '聖なる守り',
            conditions: {
                grant: '光属性への高い親和性と、慈愛の精神を持つ者。',
                maintain: '定期的な礼拝と不浄の回避。',
                loss: '背信行為、または大罪を犯すこと。'
            },
            effects: {
                direct: '光属性魔術の威力増幅、魔力自然回復速度の向上(大)。',
                indirect: '病気・毒への高耐性、アンデッドへの威圧。',
                constraints: '闇属性魔術の使用が不可能になる。'
            },
            hierarchy: {
                lower: '蛍火の加護',
                middle: '光輝の加護',
    ...
    { 
        ...
        name: '嵐刃の加護', 
        category: '属性加護', 
        description: '攻撃速度上昇・雷霆増幅・麻痺付与。', 
        compatibleAttributes: ['風属性', '雷属性', '雷霆域', '音属性'], 
        powerMultiplier: 3.8,
        lore: {
            deity: '暴風神テンペスト',
            symbol: '交差する稲妻と翼',
            alias: '戦場の疾風',
            conditions: {
                grant: '嵐の中で生き延びた者、あるいは天性の速さを持つ者。',
                maintain: '常に挑戦し続けること。',
                loss: '恐怖に屈し、逃亡すること。'
            },
            effects: {
                direct: '詠唱速度の短縮、雷属性の威力強化。',
                indirect: '落下ダメージ無効、風読みの直感。',
                constraints: '土属性（防御系）の魔術効果が半減する。'
            },
            hierarchy: {
                lower: 'そよ風の加護',
                middle: '疾風の加護',
    ...
    { 
        ...
        name: '凍月の加護', 
        category: '属性加護', 
        description: '氷結耐性・氷属性威力極大化。', 
        compatibleAttributes: ['氷属性', '水属性', '凍氷域', '黎氷域'], 
        powerMultiplier: 4.0,
        lore: {
            deity: '氷雪の女王ニブル',
            symbol: '六花（雪の結晶）',
            alias: '静寂の抱擁',
            conditions: {
                grant: '極寒の地での生存、または冷徹な理性の持ち主。',
                maintain: '感情に流されず、冷静であること。',
                loss: '激昂し、理性を失うこと。'
            },
            effects: {
                direct: '氷属性の絶対零度化、物理防御力の向上（氷衣）。',
                indirect: '精神干渉への耐性、体温低下の無効化。',
                constraints: '火属性魔術の使用時にダメージを受ける。'
            },
            hierarchy: {
                lower: '霜の加護',
                middle: '氷結の加護',
    ...
    { 
        ...
        name: '煉獄の加護', 
        category: '属性加護', 
        description: '炎属性極大化・燃焼強化。', 
        compatibleAttributes: ['火属性', '煉獄域', '灼界域'], 
        powerMultiplier: 5.0,
        lore: {
            deity: '炎帝イフリート',
            symbol: '燃え盛る心臓',
            alias: '滅びの焔',
            conditions: {
                grant: '焼き尽くしたいという強烈な渇望、または王の資質。',
                maintain: '他者を圧倒する強さを維持すること。',
                loss: '敗北し、誇りを折られること。'
            },
            effects: {
                direct: '火属性の破壊力極大化、継続燃焼効果の付与。',
                indirect: '寒冷地での活動制限解除、恐怖耐性。',
                constraints: '水属性耐性が著しく低下する。'
            },
            hierarchy: {
                lower: '火粉の加護',
                middle: '爆炎の加護',
    ...
    // ヴェルナ最強加護 (Supreme: x10.0 - x50.0)
    { 
        id: 'kago_world', 
        name: '世界の加護', 
        category: '最強加護', 
        description: '【序列1位】物質・情報・因果律の完全操作。', 
        compatibleAttributes: ['因果系', '創造系', '律界域', '時空域', '因果域', '創生域'], 
        powerMultiplier: 50.0,
        lore: {
            deity: '根源神ヴェルナ（世界意思）',
            symbol: 'ウロボロスを内包する世界樹',
            alias: '全知全能の許諾',
            conditions: {
                grant: '世界意思による直接指名。数千年に一人の逸材。',
                maintain: '世界の均衡を崩さないこと。',
                loss: '世界の敵対者となること。'
            },
            effects: {
                direct: '全系統魔法の行使可能、魔力消費ゼロ、事象改変。',
                indirect: '不老不死、因果律からの逸脱。',
                constraints: '自身の消滅を代償とする魔法のみ行使不可。'
            },
            hierarchy: {
                lower: '精霊王の加護',
                middle: '世界樹の加護',
    ...
    { 
        ...
        name: '時空の加護', 
        category: '最強加護', 
        description: '【序列2位】時間操作・因果律制御。', 
        compatibleAttributes: ['時空域', '因果系', '律界域'], 
        powerMultiplier: 30.0,
        lore: {
            deity: '時空神クロノス',
            symbol: '砂時計と無限大',
            alias: '刻の支配者',
            conditions: {
                grant: '時の狭間に落ち、帰還した者。',
                maintain: '歴史の大きな改変を行わないこと（観測者であること）。',
                loss: 'タイムパラドックスによる自己消滅。'
            },
            effects: {
                direct: '時間停止、過去改変、未来予知。',
                indirect: '老化停止、瞬間移動。',
                constraints: '自身の過去には干渉できない。'
            },
            hierarchy: {
                lower: '加速の加護',
                middle: '転移の加護',
...
// --- PREDEFINED GRIMOIRE (Database of Known Spells) ---
export const PREDEFINED_GRIMOIRE: Partial<ManifestedSpell>[] = [
    ...
    {
        id: 'LIB_002', name: 'アイシクルランス (Icicle Lance)', system: MagicSystem.ELEMENTAL, attribute: '氷属性', rank: 2,
        description: '大気中の水分を凝固させ、鋭利な氷の槍として撃ち出す。',
        chantFeedback: '絶対なる冷気、凍てつく牙となりて敵を穿て。',
        predictedDamage: 450
    },
    {
        id: 'LIB_003', name: 'サンダーボルト (Thunderbolt)', system: MagicSystem.ELEMENTAL, attribute: '雷属性', rank: 3,
        description: '瞬時に高圧電流を発生させ、直撃させる雷撃魔法。回避困難。',
        chantFeedback: '紫電の煌めき、天より降り注ぐ裁きとなれ。',
        predictedDamage: 1200
    },
    {
        id: 'LIB_004', name: 'アブソリュート・ゼロ (Absolute Zero)', system: MagicSystem.ELEMENTAL, attribute: '凍氷域', rank: 6,
        description: '対象領域の熱運動を完全停止させる戦略級氷結魔術。',
        chantFeedback: '万象を拒絶せよ。静寂なる終焉、ニブルヘイムの抱擁。',
        predictedDamage: 25000
    },
    {
        id: 'LIB_005', name: 'プロミネンス・ノヴァ (Prominence Nova)', system: MagicSystem.DAWN, attribute: '灼界域', rank: 7,
        description: '恒星の如き熱量を局所展開し、全てを灰燼に帰す禁忌魔術。',
        chantFeedback: '星の吐息、原初の炎。その輝きは全てを焼き尽くす慈愛。',
        predictedDamage: 85000
    },
    {
        id: 'LIB_006', name: 'クロノ・スタシス (Chrono Stasis)', system: MagicSystem.CAUSAL, attribute: '時空域', rank: 5,
        description: '指定座標の時間を凍結させ、因果の流れから切り離す。',
        chantFeedback: '刻の番人よ、その歩みを止めよ。永劫の牢獄。',
        predictedDamage: 0
    },
    {
        id: 'LIB_007', name: 'サンクチュアリ (Sanctuary)', system: MagicSystem.OTHER, attribute: '神聖魔法', rank: 4,
        description: '不浄なる存在を拒絶する聖なる結界を展開する。',
        chantFeedback: '聖なる光、我らを守護する盾となれ。',
        predictedDamage: 0
    },
    {
        id: 'LIB_008', name: 'ウィンドカッター (Wind Cutter)', system: MagicSystem.ELEMENTAL, attribute: '風属性', rank: 1,
        description: '真空の刃を生み出し、対象を切り裂く。',
        chantFeedback: '見えざる刃、風の囁きと共に。',
        predictedDamage: 120
    }
];

// --- HIDDEN COMMANDS (SECRET ARTS) ---
const HIDDEN_ARTS = [
    {
    ...
    {
        condition: { protectionId: 'kago_hero', system: MagicSystem.DAWN, attribute: '星焔域', rank: 7 },
        data: {
            name: 'スーパーノヴァ・ジェネシス (Supernova Genesis)',
            description: '【裏奥義】超新星爆発を掌中に生み出し、新たな宇宙を創造するほどのエネルギーを放つ。',
            chantFeedback: '星々の輝き、集いて新たな希望となれ。創世の光！',
            predictedDamage: 7777777,
            eyeColor: '#fbbf24'
        }
    },
    {
        condition: { protectionId: 'kago_curse', system: MagicSystem.ELEMENTAL, attribute: '闇属性', rank: 6 },
        data: {
            name: 'アビス・スクリーム (Abyssal Scream)',
            description: '【裏奥義】深淵の絶望を具現化した咆哮。聞いた者の魂を永遠の闇へと引きずり込む。',
            chantFeedback: '嘆け、叫べ、絶望せよ。奈落の底で我と共に...。',
            predictedDamage: 666666,
            eyeColor: '#7e22ce'
        }
    },
    {
        condition: { protectionId: 'kago_sword', system: MagicSystem.ELEMENTAL, attribute: '風属性', rank: 5 },
        data: {
            name: 'ディメンション・スラッシュ (Dimension Slash)',
            description: '【裏奥義】次元そのものを断ち切る剣聖の一撃。防御不可能。',
            chantFeedback: '我が剣に断てぬものなし。次元ごと両断する！',
            predictedDamage: 444444,
            eyeColor: '#10b981'
        }
    }
];
...
const RANK_MODIFIERS: Record<number, { prefix: string, suffix: string, theory: string, effect: string }> = {
  1: { prefix: '初歩的な', suffix: 'の操作', theory: '局所的なW粒子の励起', effect: '微細な物理干渉' },
  2: { prefix: '形成された', suffix: 'の矢', theory: 'ベクトル制御と指向性付与', effect: '物理的損壊' },
  3: { prefix: '展開せし', suffix: 'の陣', theory: '術式回路の多重展開', effect: '広範囲への影響' },
  4: { prefix: '吹き荒れる', suffix: 'の嵐', theory: '環境マナの強制循環', effect: '地形への干渉' },
  5: { prefix: '支配する', suffix: 'の領域', theory: '局所物理法則の書き換え', effect: '自然災害級の破壊' },
  6: { prefix: '天を衝く', suffix: 'の神撃', theory: '位相次元の圧縮と解放', effect: '都市壊滅級の現象' },
  7: { prefix: '終焉をもたらす', suffix: 'の理', theory: '因果律の根源的改変', effect: '世界法則の再定義' },
};
...
// Deterministic Spell Construction
export const constructSpell = async (
  ...
  // If Hidden Art detected, use its data primarily
  if (hiddenArt) {
      ...
      return {
          ...
          lore: {
              magicType: 'Hidden Art (裏奥義)',
              medium: 'Divine Will',
              condition: 'Specific Protection Resonance',
              cost: 'None',
              theory: 'Divine Intervention',
              origin: 'Akashic Records',
              famousUser: 'The Player'
          }
      };
  }

  // Name Generation - If known spell, use its name. Else fallback to system name.
  const name = knownSpell?.name || `${attrData.kanji}${rankData.suffix}`;
  
  // Chant Generation - If known, use it.
  ...
  // OIP Data (Internal Influence: Brainwaves)
  const baseAmp = Math.pow(10, rank).toExponential(2);
  const frequencyVal = Math.random() * 100 + 400; // THz
  const frequency = `${frequencyVal.toFixed(2)} THz`;
  
  // Update Consciousness Level based on Emotion Index
  ...
  // 1. Base Damage (Rank Exponential)
  // If known spell has predicted damage, use that as base scale, but still fluctuate it
  const baseDamageVal = knownSpell?.predictedDamage || (50 * Math.pow(6, rank)); 
  
  // 2. Internal Factor (Emotion + Vitals + HP Synergy)
  ...
  if (hpRatio <= 0.05 && hpRatio > 0) {
      // CRISIS BOOST (Kajiba no Bakajikara)
      internalMult *= 3.0;
      hpMultStr = "x3.0 (CRISIS BOOST)";
  } else {
      // Normal Scale: Low HP = Low Performance (Linear scale from 0.5 to 1.0)
      const healthFactor = 0.5 + (hpRatio * 0.5); 
      internalMult *= healthFactor;
      hpMultStr = `x${healthFactor.toFixed(2)} (Health Factor)`;
  }

  // 3. External Factor (W-Density + Weather Synergy)
  let weatherSynergy = 1.0;
  if (attribute.includes('火') || attribute.includes('煉獄')) {
      if (environment.temperature > 25) weatherSynergy += 0.2;
      if (environment.humidity < 40) weatherSynergy += 0.2;
  } else if (attribute.includes('水') || attribute.includes('氷')) {
      if (environment.temperature < 10) weatherSynergy += 0.2;
      if (environment.humidity > 60) weatherSynergy += 0.2;
  }
  const externalMult = (environment.wDensity / 3000) * weatherSynergy;

  // 4. Protection Multiplier (Updated Logic)
  let protectionMult = 1.0;
  let protectionStatus = "Inactive";
  if (protection.id !== 'none') {
    // Check compatibility using substring match or exact match from compatibleAttributes
    if (protection.compatibleAttributes.some(c => attribute.includes(c) || system.includes(c))) {
        ...
        // Penalty or neutral if not compatible? Let's keep it neutral but weak.
        protectionMult = 1.0; 
  ...
  const formula = `
    ...
    [EXTERNAL] (W-Density ${environment.wDensity} + Env): x${externalMult.toFixed(2)}
